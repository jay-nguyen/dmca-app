...
@section('content')
    ...
    {!! Form::open(['method' => 'GET', 'action' => 'NoticesController@confirm']) !!}
        ...
        <div class="form-group">
            {!! Form::label('infringing_title', 'What is the title of the content being infringed upon?') !!}
        ...
        <div class="form-group">
            {!! Form::label('original_description', 'It might help to provide some extra information related to this DMCA notice.') !!}
